...
<nav id="main-nav" class="fixed top-0 left-0 right-0 z-[100] h-[60px] flex items-center justify-between px-4 sm:px-6 md:px-10 gap-0 transition-all duration-300 border-b border-transparent">
  ...
  <div class="hidden md:flex items-center gap-0 ml-9">
    ...
    <a href="{{ route('compare') }}" class="nav-link font-heading text-xs font-semibold tracking-[0.8px] uppercase text-muted px-3 py-1.5 rounded-md transition-all duration-150 no-underline border-b-2 border-transparent hover:text-text-light">Compare</a>
    <a href="{{ route('leaderboard') }}" class="nav-link font-heading text-xs font-semibold tracking-[0.8px] uppercase text-muted px-3 py-1.5 rounded-md transition-all duration-150 no-underline border-b-2 border-transparent hover:text-text-light">Predictions</a>
