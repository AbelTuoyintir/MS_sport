...
<div class="flex justify-between items-center mb-6">
    ...
    <a href="{{ route('admin.teams.create') }}" class="bg-accent-gold text-bg-dark px-4 py-2 rounded-lg font-bold text-sm hover:opacity-90 transition-opacity">Add New Club</a>
</div>
    ...
    <table class="w-full text-left">
        <thead>
            <tr class="border-b border-white/10 bg-white/5">
                <th class="px-6 py-3 text-xs font-bold uppercase tracking-wider text-gray-400">Club</th>
                <th class="px-6 py-3 text-xs font-bold uppercase tracking-wider text-gray-400">Division</th>
                <th class="px-6 py-3 text-xs font-bold uppercase tracking-wider text-gray-400">Stadium</th>
                <th class="px-6 py-3 text-xs font-bold uppercase tracking-wider text-gray-400">Status</th>
                <th class="px-6 py-3 text-xs font-bold uppercase tracking-wider text-gray-400">Actions</th>
            </tr>
        </thead>
        <tbody>
