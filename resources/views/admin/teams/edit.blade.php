    ...
    <div class="glass-card p-8">
        <form action="{{ route('admin.teams.update', $team->id) }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label class="block text-xs font-bold text-gray-400 uppercase mb-2">Team Name</label>
                ...
                <div>
                    <label class="block text-xs font-bold text-gray-400 uppercase mb-2">Division</label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label class="block text-xs font-bold text-gray-400 uppercase mb-2">Squad Size</label>
                ...
                <div>
                    <label class="block text-xs font-bold text-gray-400 uppercase mb-2">Registration Status</label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label class="block text-xs font-bold text-gray-400 uppercase mb-2">Home Stadium</label>
                ...
                <div>
                    <label class="block text-xs font-bold text-gray-400 uppercase mb-2">City</label>
            ...
            <button type="submit" class="w-full bg-accent-gold text-bg-dark font-bold py-3 rounded-lg mt-4 uppercase tracking-widest hover:opacity-90 transition-opacity">Update Team</button>
        </form>
    </div>
</div>
@endsection
