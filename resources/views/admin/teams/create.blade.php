...
<div class="max-w-2xl mx-auto">
    ...
    <div class="glass-card p-8">
        <form action="{{ route('admin.teams.store') }}" method="POST" class="space-y-6">
            ...
            <button type="submit" class="w-full bg-accent-gold text-bg-dark font-bold py-3 rounded-lg mt-4 uppercase tracking-widest hover:opacity-90 transition-opacity">Create Team</button>
        </form>
    </div>
</div>
@endsection
